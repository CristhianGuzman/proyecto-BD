...
public class JFopciones extends javax.swing.JFrame{
    ...
    public JFopciones(jPservicio panel) {
        initComponents();
        this.panel = panel;
        setVisible(true); 
    ...
    public JFopciones(jPhabitacion panel) {
        initComponents();
        setVisible(true); 
        setLocationRelativeTo(panel);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createTitledBorder("Options")));
        ...
        jButton1.setText("OK");
        jButton1.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 102, 204)));
        ...
        jButton2.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(0, 102, 204)));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jRadioButton1.isSelected()){
             if(panel instanceof jPservicio){
                dispose();
                jPservicio panelServ = (jPservicio)panel;
                panelServ.manejaOpciones("eliminar");
            }else
            if(panel instanceof jPhabitacion){
        ...
        if(jRadioButton2.isSelected()){
            if(panel instanceof jPservicio){
                jPservicio panelServ = (jPservicio)panel;
                panelServ.manejaOpciones("actualizar");
                dispose();
